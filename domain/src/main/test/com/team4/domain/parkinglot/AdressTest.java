...
class AdressTest {
    ...
    void whenPostalCodeIsInvalid_exceptionIsThrown() {
        Assertions.assertThrows(DomainException.class, () -> new Adress("elfnovemberlaan","82","azerty"));
        Assertions.assertThrows(DomainException.class, () -> new Adress("elfnovemberlaan","82","3010,leuven"));
        Assertions.assertThrows(DomainException.class, () -> new Adress("elfnovemberlaan","82","3010leuven"));
